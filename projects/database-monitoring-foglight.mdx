<h1 className="text-4xl font-bold mb-8">SMA LLC - Database Monitoring Tools for Quest Foglight</h1>
...
<div className="project-container">
    ...
    <div className="role-tech-container">
        <div className="role-container">
            ...
            <span className="role-text">Java Developer, Web Developer</span>
        </div>
        <div className="role-container">
            <span className="role-label">Date:</span>
            <span className="role-text">08/2022 - 08/2024</span>
        </div>
        <div className="tech-container">
            ...
            <div className="tech-list">
                ...
                <span className="tech-badge">SAP HANA</span>
