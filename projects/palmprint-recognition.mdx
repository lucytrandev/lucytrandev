<h1 className="text-4xl font-bold mb-8">Palmprint Recognition System with Self-Supervised Learning</h1>
...
<div className="project-container">
    ...
    <div className="role-tech-container">
        <div className="role-container">
            ...
            <span className="role-text">Python Developer, AI/ML</span>
        </div>
        <div className="role-container">
            <span className="role-label">Date:</span>
            <span className="role-text">02/2025 - 02/2025</span>
        </div>
        <div className="tech-container">
            <span className="tech-label">Technologies:</span>
            <div className="tech-list">
                <span className="tech-badge">Python</span>
                <span className="tech-badge">Self-Supervised Learning</span>
                <span className="tech-badge">Contrastive Learning (SimCLR-inspired)</span>
                <span className="tech-badge">ResNet-18</span>
                <span className="tech-badge">ImageNet Pre-training</span>
                <span className="tech-badge">NT-Xent Loss</span>
